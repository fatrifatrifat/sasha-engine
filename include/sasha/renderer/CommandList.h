...
public:
	...
	void Reset(ID3D12CommandAllocator* cmdAlloc, ID3D12PipelineState* pso = nullptr);
	void ChangeResourceState(ID3D12Resource* resource, D3D12_RESOURCE_STATES base, D3D12_RESOURCE_STATES change, UINT numBarrier = 1u);
